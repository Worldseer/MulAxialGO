...
@ck.command()
@ck.option(
    '--data-root', '-dr', default='/storage/home/qp/CAFA4',
    help='Prediction model')
@ck.option(
    '--ont', '-ont', default='cc',
    help='Prediction model')
@ck.option(
    '--model', '-m', default='axialgo_blast',
    help='Prediction model')
@ck.option(
    '--combine', '-c', default=True, is_flag=True,
    help='Prediction model')
def main(data_root, ont, model, combine):
    ...
    test_data_file = f'{data_root}/predict/AxialGO_MFO_blast.pkl'
